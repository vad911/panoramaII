...
//	cv::Mat image_02_origin = cv::imread("Pan08_02.png");
	...
	// !!! важно правильно указать последовательность точек - img2, img1, 
	// это значит приводим координаты изображения img2 к координатам изображения - img1
	// если указать обратное у нас будет неправильный результат
